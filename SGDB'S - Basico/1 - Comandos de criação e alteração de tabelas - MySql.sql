#Comandos de criação, um esquema é um agrupador de elementos de banco de dados, geralmente ligado a uma aplicação
...
#Comandos de alteração das tabelas, fazendo a ligação entre as relações através das chaves
