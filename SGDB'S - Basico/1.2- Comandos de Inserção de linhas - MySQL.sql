#Esse comando ignora a checagem de chaves estrangeiras, isso é perigosa pois pode ocorrer de quebrarmos a integridade
SET FOREIGN_KEY_CHECKS = 0;

#Os valores de inserção devem ser inseridos na ordem em que os atributos foram especificados, porém também podemos inserir em uma
#ordem especificada no INSERT onde dizemos quais campos vamos inserir
...
#Com o parâmetro 1 eu ligo a checagem de integridade das chaves estrangeiras
